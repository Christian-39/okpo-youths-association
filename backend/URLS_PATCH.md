...
urlpatterns = [
    ...
    path("api/api/users/search/", views.user_search_ajax, name="user_search_ajax"),
    # NEW — standalone-frontend JSON API
    path("api/api/csrf/", api.csrf_api, name="csrf_api"),
    path("api/api/login/", api.login_api, name="login_api"),
    path("api/api/logout/", api.logout_api, name="logout_api"),
    path("api/api/me/", api.me_api, name="me_api"),
]
```
...
urlpatterns = [
    ...
    # NEW — standalone-frontend JSON API
    path("api/api/list/", api.member_list_api, name="member_list_api"),
    path("api/api/create/", api.member_create_api, name="member_create_api"),
    path("api/api/<int:pk>/", api.member_detail_api, name="member_detail_api"),
    path("api/api/<int:pk>/update/", api.member_update_api, name="member_update_api"),
]
```
...
urlpatterns = [
    ...
    path("api/member/", views.member_dashboard, name="member_dashboard"),
    ...
    # NEW — standalone-frontend JSON API
    path("api/api/summary/", api.dashboard_api, name="dashboard_api"),
]
```
...
urlpatterns = [
    ...
    path("api/api/unread-count/", api.unread_count_api, name="unread_count_api"),
]
```
...
urlpatterns = [
    ...
    path("api/api/donations/", api.donation_list_api, name="donation_list_api"),
    path("api/api/donations/create/", api.income_create_api, name="income_create_api"),
    path("api/api/donations/<int:pk>/", api.income_detail_api, name="income_detail_api"),
    path("api/api/donations/<int:pk>/delete/", api.income_delete_api, name="income_delete_api"),
    path("api/api/expenses/", api.expense_list_api, name="expense_list_api"),
    path("api/api/expenses/create/", api.expense_create_api, name="expense_create_api"),
    path("api/api/expenses/<int:pk>/", api.expense_detail_api, name="expense_detail_api"),
    path("api/api/expenses/<int:pk>/delete/", api.expense_delete_api, name="expense_delete_api"),

    # NEW — dues tracker JSON API
    path("api/api/dues/tracker/", api.dues_tracker_api, name="dues_tracker_api"),
    path("api/api/dues/members/<int:member_id>/", api.member_dues_detail_api, name="member_dues_detail_api"),
    path("api/api/dues/preview/", api.member_dues_preview_api, name="member_dues_preview_api"),
    path("api/api/dues/allocate/form-meta/", api.dues_allocate_form_meta_api, name="dues_allocate_form_meta_api"),
    path("api/api/dues/allocate/", api.dues_allocate_api, name="dues_allocate_api"),
    path("api/api/dues/<int:pk>/delete/", api.dues_delete_api, name="dues_delete_api"),
    path("api/api/dues/prepaid/", api.prepaid_list_api, name="prepaid_list_api"),
    path("api/api/dues/prepaid/<int:member_id>/", api.prepaid_detail_api, name="prepaid_detail_api"),
    path("api/api/dues/debtors/", api.dues_debtors_list_api, name="dues_debtors_list_api"),
]
```
...
urlpatterns = [
    ...
    # NEW — standalone-frontend JSON API
    path("api/api/list/", api.executive_list_api, name="executive_list_api"),
    path("api/api/form-meta/", api.executive_form_meta_api, name="executive_form_meta_api"),
    path("api/api/create/", api.executive_create_api, name="executive_create_api"),
    path("api/api/<int:pk>/", api.executive_detail_api, name="executive_detail_api"),
    path("api/api/<int:pk>/form-meta/", api.executive_form_meta_api, name="executive_form_meta_edit_api"),
    path("api/api/<int:pk>/update/", api.executive_update_api, name="executive_update_api"),
    path("api/api/<int:pk>/end-tenure/", api.executive_end_tenure_api, name="executive_end_tenure_api"),
]
```
...
urlpatterns = [
    ...
    path("api/api/list/", api.auditlog_list_api, name="auditlog_list_api"),
    path("api/api/<int:pk>/detail/", api.auditlog_detail_api, name="auditlog_detail_api"),
]
```
...
urlpatterns = [
    ...
    path("api/api/settings/", api.system_settings_api, name="system_settings_api"),
    path("api/api/settings/update/", api.system_settings_update_api, name="system_settings_update_api"),
    path("api/api/donation-groups/", api.donation_group_list_api, name="donation_group_list_api"),
    path("api/api/donation-groups/create/", api.donation_group_create_api, name="donation_group_create_api"),
    path("api/api/donation-groups/<int:pk>/", api.donation_group_detail_api, name="donation_group_detail_api"),
    path("api/api/donation-groups/<int:pk>/update/", api.donation_group_update_api, name="donation_group_update_api"),
    path("api/api/donation-groups/<int:pk>/delete/", api.donation_group_delete_api, name="donation_group_delete_api"),
    path("api/api/donation-groups/<int:pk>/toggle-active/", api.donation_group_toggle_active_api, name="donation_group_toggle_active_api"),
    path("api/api/donation-groups/<int:pk>/members/add/", api.donation_group_member_add_api, name="donation_group_member_add_api"),
    path("api/api/donation-groups/<int:pk>/members/<int:membership_pk>/remove/", api.donation_group_member_remove_api, name="donation_group_member_remove_api"),
]
```
...
urlpatterns = [
    ...
    # NEW — standalone-frontend JSON API
    path("api/api/list/", api.project_list_api, name="project_list_api"),
    path("api/api/create/", api.project_create_api, name="project_create_api"),
    path("api/api/<int:pk>/", api.project_detail_api, name="project_detail_api"),
    path("api/api/<int:pk>/update/", api.project_update_api, name="project_update_api"),
    path("api/api/<int:pk>/delete/", api.project_delete_api, name="project_delete_api"),
]
```
...
urlpatterns = [
    ...
    path("api/api/list/", api.election_list_api, name="election_list_api"),
    path("api/api/create/", api.election_create_api, name="election_create_api"),
    path("api/api/<int:pk>/", api.election_detail_api, name="election_detail_api"),
    path("api/api/<int:pk>/update/", api.election_update_api, name="election_update_api"),
    path("api/api/candidates/form-meta/", api.candidate_form_meta_api, name="candidate_form_meta_api"),
    path("api/api/candidates/create/", api.candidate_create_api, name="candidate_create_api"),
    path("api/api/candidates/<int:pk>/", api.candidate_detail_api, name="candidate_detail_api"),
    path("api/api/candidates/<int:pk>/update/", api.candidate_update_api, name="candidate_update_api"),
    path("api/api/candidates/<int:pk>/vote/", api.cast_vote_api, name="cast_vote_api"),
]
```
...
urlpatterns = [
    ...
    # NEW — standalone-frontend JSON API
    path("api/api/taskforce/list/", api.taskforce_list_api, name="taskforce_list_api"),
    path("api/api/taskforce/form-meta/", api.taskforce_form_meta_api, name="taskforce_form_meta_api"),
    path("api/api/taskforce/create/", api.taskforce_create_api, name="taskforce_create_api"),
    path("api/api/taskforce/<int:pk>/", api.taskforce_detail_api, name="taskforce_detail_api"),
    path("api/api/taskforce/<int:pk>/update/", api.taskforce_update_api, name="taskforce_update_api"),
    path("api/api/taskforce/<int:pk>/remove/", api.taskforce_remove_api, name="taskforce_remove_api"),

    path("api/api/motorcycles/list/", api.motorcycle_list_api, name="motorcycle_list_api"),
    path("api/api/motorcycles/form-meta/", api.motorcycle_form_meta_api, name="motorcycle_form_meta_api"),
    path("api/api/motorcycles/create/", api.motorcycle_create_api, name="motorcycle_create_api"),
    path("api/api/motorcycles/<int:pk>/", api.motorcycle_detail_api, name="motorcycle_detail_api"),
    path("api/api/motorcycles/<int:pk>/update/", api.motorcycle_update_api, name="motorcycle_update_api"),
    path("api/api/motorcycles/<int:pk>/delete/", api.motorcycle_delete_api, name="motorcycle_delete_api"),

    path("api/api/cases/list/", api.case_list_api, name="case_list_api"),
    path("api/api/cases/form-meta/", api.case_form_meta_api, name="case_form_meta_api"),
    path("api/api/cases/<int:pk>/form-meta/", api.case_form_meta_api, name="case_form_meta_edit_api"),
    path("api/api/cases/create/", api.case_create_api, name="case_create_api"),
    path("api/api/cases/<int:pk>/", api.case_detail_api, name="case_detail_api"),
    path("api/api/cases/<int:pk>/update/", api.case_update_api, name="case_update_api"),
    path("api/api/cases/<int:pk>/resolve/", api.case_resolve_api, name="case_resolve_api"),
    path("api/api/cases/<int:pk>/delete/", api.case_delete_api, name="case_delete_api"),
]
```
...
urlpatterns = [
    ...
    path("api/api/outside-donors/list/", api.outside_donor_list_api, name="outside_donor_list_api"),
    path("api/api/outside-donors/form-meta/", api.outside_donor_form_meta_api, name="outside_donor_form_meta_api"),
    path("api/api/outside-donors/create/", api.outside_donor_create_api, name="outside_donor_create_api"),
    path("api/api/outside-donors/<int:pk>/", api.outside_donor_detail_api, name="outside_donor_detail_api"),
    path("api/api/outside-donors/<int:pk>/update/", api.outside_donor_update_api, name="outside_donor_update_api"),
    path("api/api/outside-donors/<int:pk>/delete/", api.outside_donor_delete_api, name="outside_donor_delete_api"),

    path("api/api/donations/list/", api.donation_list_api, name="donation_list_api"),
    path("api/api/donations/form-meta/", api.donation_form_meta_api, name="donation_form_meta_api"),
    path("api/api/donations/create/", api.donation_create_api, name="donation_create_api"),
    path("api/api/donations/<int:pk>/", api.donation_detail_api, name="donation_detail_api"),
    path("api/api/donations/<int:pk>/update/", api.donation_update_api, name="donation_update_api"),
    path("api/api/donations/<int:pk>/delete/", api.donation_delete_api, name="donation_delete_api"),
    path("api/api/donations/<int:pk>/fulfill/", api.donation_fulfill_api, name="donation_fulfill_api"),
    path("api/api/donations/<int:pk>/cancel-pledge/", api.donation_cancel_pledge_api, name="donation_cancel_pledge_api"),
]
```
